...
function openWin(n,x) {
	...
	if (x == 1){
		...
		dokter = "dr. Fitriani Nasution, Sp.S"
	} 
	 ...
	 if ($rowinternis < 8 ) {
		 echo"	 
		  <div class='w3-display-middleright' id='feature3'> 
			<a href='submenurajalbpjssaraf.php?act=drfitriani' class='btn btn-lg btn-default wow fadeInUp'>
				<p style='font-size:50px;'>dr. Fitriani Nasution, Sp.S</p>
			</a>
		  </div>";
	 } else {
		 echo"	 
		  <div class='w3-display-middleright' id='feature3'> 
			<a href='submenurajalbpjssaraf.php?act=tutup' class='w3-black btn btn-lg btn-default wow fadeInUp'>
				<p style='color:white;font-size:50px;'>dr. Fitriani Nasution, Sp.S</p>
			</a>
		  </div>";
	 }
