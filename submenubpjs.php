...
function openWin(n) {
  ...
  myWindow.document.write("<center><h3>Rawat Inap BPJS</h3> <h1 style='font-size:500%;'>A" + n +"</h1> " + "<p> Jika nomor terlewat akan dipanggil setelah 3 nomor</p>" + result + "</center>");
  myWindow.print();
  myWindow.close();
}
</script>
